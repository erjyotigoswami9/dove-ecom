...
export const MenuNavbar = () => {
  ...
  return (
    // <!--  selecting items based on requirements -->
    <div className="subNavDiv">
    <div className="secondNavbarSelect">
    ...
    <div className="secondNavbarSelect">
        <div className="haircareDiv">
            <button className="stopTheBeautyTestButton">#stopTheBeautyTest</button>
        </div>
    </div>
    <div className="secondNavbarSelect">
        <div className="haircareDiv">
    ...
    <div className="secondNavbarSelect">
        <div className="haircareDiv">
            <button onClick={handleProfile} className="imageProfile"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ_5vRSzfNq8yKeZ0xk4EUDyeBU_4Q6lMT_3Q&s" alt="profile"/></button>
        </div>
    </div>
    <div className="secondNavbarSelect">
        <div className="haircareDiv">
            <button className="imageProfile" onClick={handleCart}>
